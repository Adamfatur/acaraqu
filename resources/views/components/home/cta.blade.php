    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div :class="shown ? 'animate-scale-up' : 'opacity-0'">
            <h2 class="text-4xl md:text-6xl font-bold text-white mb-8 leading-tight">
                ...
                yang <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Luar Biasa?</span>
            </h2>
            <p class="text-xl text-iron mb-12 max-w-2xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
                <a href="#contact" class="group relative px-8 py-4 bg-iron text-blue-chill rounded-full font-bold text-lg hover:bg-white transition-all duration-300 shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_-15px_rgba(255,255,255,0.5)] hover:-translate-y-1">
