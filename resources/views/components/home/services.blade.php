    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-20 max-w-3xl mx-auto" :class="shown ? 'animate-fade-in-up' : 'opacity-0'">
            ...
            <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 tracking-tight">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-chill to-purple-600 animate-gradient">Dalam Satu Atap</span>
            </h2>
            <p class="text-slate-500 text-lg leading-relaxed text-gothic">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" :class="shown ? 'animate-fade-in-up' : 'opacity-0'" style="animation-delay: 0.2s">
            ...
            <!-- Card: GaleriQu -->
            <div class="group relative bg-white rounded-[2.5rem] p-8 lg:p-10 shadow-lg border border-slate-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col justify-between h-full">
                <div>
